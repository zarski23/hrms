        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-lists-center">
                    <div class="col">
                        <h3 class="page-title">Application Access</h3>
                        <ul class="breadcrumb">
                    ...
                    <div class="col-auto float-right ml-auto">
                        <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_employee"><i class="fa fa-plus"></i> Add Employee Access</a>
                        ...
                        <div class="profile-widget" style="padding-bottom: 0;">
                            ...
                            <div class="dropdown profile-action">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#update_employee"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                    <a class="dropdown-item" href="{{url('employee/access/delete/'.$lists->id)}}"onclick="return confirm('Are you sure to want to delete it?')"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                </div>
                            </div>
                            <h5 class="user-name m-t-10 mb-0 text-ellipsis"><a href="profile.html">{{ $lists->first_name }} {{ $lists->last_name }}</a></h5>
                            <p style="font-size: 11px; margin-top: 5px; color: #04882d;">{{ $lists->user_role }} <br>{{ $lists->application_name }} </p>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Add Employee Access</h5>
