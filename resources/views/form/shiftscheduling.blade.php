            ...
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-auto float-right ml-auto">
                        <a href="" class="btn add-btn m-r-5">Shifts</a>
                                ...
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            <a href="profile.html">Baduya, Michael <span>Job Order</span></a>
                                        </h2>
                                    </td>
                                    <td>
                                        <div class="user-add-shedule-list">
                                            <h2>
                                                ...
                                                <span class="username-info m-b-10">11:00 pm - 7:00 am ( 8 hrs )</span>
                                                <span class="userrole-info">Night Shift</span>
                                                </a>
                                            </h2>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            <a href="profile.html">Balais, Melvin <span>Job Order</span></a>
                                        </h2>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            <a href="profile.html">Asis, April Jhon <span>Job Order</span></a>
                                        </h2>
                                    </td>
                                    ...
                                    <td>
                                        <div class="user-add-shedule-list">
                                            <h2>
                                                <a href="#" data-toggle="modal" data-target="#edit_schedule" style="border:2px dashed #1eb53a">
                                                <span class="username-info m-b-10">7:00 am - 3:00 pm ( 8 hrs )</span>
                                                <span class="userrole-info">Morning Shift</span>
                                                </a>
                                            </h2>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            <a href="profile.html">Afable, James <span>Job Order</span></a>
                                        </h2>
                                    </td>
                                    <td>
                                        <div class="user-add-shedule-list">
