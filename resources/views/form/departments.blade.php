...
@section('content')
                ...
                <div class="col-md-12">
                    <div>
                        <table class="table table-striped custom-table mb-0 datatable">
                            ...
                            <tbody>
                                @foreach ($employeeDepartment as $key=>$items )
                                <tr>
                                    <td>{{ ++$key }}</td>
                                    <td hidden class="department_id">{{ $items->department_id }}</td>
                                    <td class="department">{{ $items->department_name }}</td>
                                    <td class="text-right">
        ...
        <div id="edit_department" class="modal custom-modal fade" role="dialog">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('admin/edit/department') }}" method="POST">
                            @csrf
                            <input type="hidden" name="id" id="e_id" value="">
                            <div class="form-group">
                                <label>Department Name <span class="text-danger">*</span></label>
                                <input type="hidden" class="form-control" id="department_id_edit" name="department_id" value="">
    ...
    <script>
        $(document).on('click','.edit_department',function()
        {
            ...
            $('#department_id_edit').val(_this.find('.department_id').text());
