...
@section('content')
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">List of Positions</h3>
                        <ul class="breadcrumb">
                ...
                <div class="col-md-12">
                    <div>
                        <table class="table table-striped custom-table mb-0 datatable">
                            ...
                            <tbody>
                                @foreach ($employeePositions as $key=>$items )
                                <tr>
                                    <td>{{ ++$key }}</td>
                                    <td hidden class="position_id">{{ $items->position_id }}</td>
                                    <td class="position">{{ $items->position_name }}</td>
                                    <td class="text-right">
                                    <div class="dropdown dropdown-action">
                                            <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item  edit_position" href="#" data-toggle="modal" data-target="#edit_position"><i class="fa fa-pencil m-r-5"></i> Edit</a>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('admin/add/position') }}" method="POST">
                            @csrf
        ...
        <div id="edit_position" class="modal custom-modal fade" role="dialog">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('admin/edit/position') }}" method="POST">
                            @csrf
                            <input type="hidden" name="id" id="e_id" value="">
                            <div class="form-group">
                                <label>Position Name <span class="text-danger">*</span></label>
                                <input type="hidden" class="form-control" id="position_id_edit" name="position_id" value="">
    ...
    <script>
        $(document).on('click','.edit_position',function()
        {
            ...
            $('#position_id_edit').val(_this.find('.position_id').text());
