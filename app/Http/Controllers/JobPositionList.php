...
class JobPositionList extends Controller
{
    public function viewJobPositions(){
        
        $jobPositions = (new UserManagementController)->getJobPositions();
        
        dd($jobPositions);

        return view('form.positions',compact('jobPositions'));
    }
